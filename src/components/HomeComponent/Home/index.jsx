...
export default class Home extends Component {
  ...
  render() {
    return (
      ...
      <div className="w-full  z-0 overflow-hidden bg-black"> 
      <div >
      <video src={videobg} autoPlay loop muted className=" absolute py-0 px-0 w-auto min-w-full max-w-none opacity-70 overflow-hidden" />
      </div>
            <div className={`  ${styles.paddingX} ${styles.flexCenter} mt-[200px]`}>
              <div className={` ${styles.boxWidth} h-[350px]`}>
                <Intro />
              </div>
            </div>
