...
<div className='p-[100px] mt-[680px] w-[1000px] h-[580px] fixed bg-green-900 z-50 flex justify-center items-center'>
  ...
  <div className='w-[700px] h-[450px]  flex items-start flex-col' >
    ...
    <p className='text-white mt-[60px] text-3xl'> Now, let's see the <span className='text-green-200'>top 5 most efficient TV </span> in terms of its performance and energy use  </p>
